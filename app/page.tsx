...
const DashBoardPage = () => {
  ...
  return (
    <>
      ...
      <span
        className={`${roboto_init.className} text-4xl font-bold px-3 text-slate-300 `}
      >
        Crypto-Dash
      </span>
      <span
        className={`${noto_init.className} text-4xl font-bold px-3 text-slate-600`}
      >
        Crypto-Dash
      </span>
      <span
        className={`${lato_init.className} text-4xl font-bold px-3 text-zinc-500`}
      >
        Crypto-Dash
      </span>
      <span
        className={`${lato_init.className} text-4xl font-bold px-3 text-neutral-400`}
      >
        Crypto-Dash
      </span>
      <span
        className={`${lato_init.className} text-4xl font-bold px-3 text-stone-700 `}
      >
        Crypto-Dash
      </span>
      <span
        className={`${lato_init.className} text-4xl font-bold px-3 text-teal-500 `}
      >
        Crypto-Dash
      </span>
      <span
      ...
      <div className="container mx-auto mt-5">
        <div className="grid grid-md-cols-3 grid-1 gap-4">
          ...
          <div className="bg-[#1e2026] p-3 rounded-md">
            ...
            <div className={`${poppins_init.className} border-2 border-b-indigo-800 border-x-0 border-t-0`}>
              <p className="text-slate-300">BORROW APY</p>
            </div>

                <div
                  className={`${noto_init.className} font-semibold mt-3 font-text text-slate-300 `}
                >
                  Binance
                </div>
          ...
          <div className="bg-[#1e2026] p-3 rounded-md">
          <div className={`${poppins_init.className} border-2 border-b-indigo-800 border-x-0 border-t-0`}>
              <p className="text-slate-300">SUPPLY APY</p>
            </div>
